...
,m_InstanceBuffer(Device, CommandList, 4096)
{
    ...
    const D3D12_INPUT_ELEMENT_DESC InputElementDescs[] =
    {
        ...
        {"TexCoord", 1, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D12_APPEND_ALIGNED_ELEMENT, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1},
        {"BlendIndices", 0, DXGI_FORMAT_R32G32_UINT, 0, D3D12_APPEND_ALIGNED_ELEMENT, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1}
    };
